...
import { CameraInputSchema, createCamera, deleteCamera, getCamera, listCameras, toPublicCamera, updateCamera, } from "./cameras.js";
import { compressSegment, getActiveJobs, listRecordings, startCameraLoop, stopCameraLoop, syncCameraLoops, } from "./compress.js";
import { config } from "./config.js";
import { audit } from "./db.js";
import { acknowledgeAlert, createAlert, getSettings, listAlerts, listAuditLogs, listSystemLogs, setSetting, systemLog, } from "./logs.js";
import { listStrategyDocs } from "./compression-strategy.js";
import { effectiveEntitlements, getInstalledLicense, installLicense, } from "./license.js";
import { getLatestSample, getRecentSamples, getUsageSummary, } from "./metrics.js";
import { createStorageTarget, deleteStorageTarget, listStorageTargets, StorageInputSchema, toPublicStorage, } from "./storage.js";
import { authenticateUser, createUser, CreateUserSchema, deleteUser, getUserById, getUserByUsername, listUsers, ProfileUpdateSchema, toPublicUser, updateProfile, updateUser, UpdateUserSchema, } from "./users.js";
export async function registerRoutes(app) {
    ...
    app.post("/api/cameras/:id/capture", { preHandler: [app.requireRole("operator")] }, async (req, reply) => {
        const { id } = req.params;
    ...
    app.get("/api/dashboard", { preHandler: [app.authenticate] }, async () => {
        ...
        const uploaded = recs.filter((r) => r.status === "uploaded").length;
    ...
    app.get("/api/about", { preHandler: [app.authenticate] }, async () => ({
        name: "Vixel",
        version: "1.2.0",
        description: "Open, brand-agnostic IP camera compressor using Zipstream-inspired GoV / I-P-B / static decimation.",
        roles: [
