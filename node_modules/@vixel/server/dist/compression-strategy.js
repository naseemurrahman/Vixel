 ...
 */
export const COMPRESSION_PROFILES = ["zipstream", "balanced", "forensic"];
const PROFILE_META = {
    zipstream: {
        description: "Zipstream-class: drop static duplicates, long GoV, strong AQ — best for quiet scenes (≥80% typical).",
 ...
 */
function decimateFilter(profile) {
 ...
 */
function govParams(gop, bframes, profile) {
 ...
 */
export function compressionRatio(bytesIn, bytesOut) {
    if (bytesIn <= 0)
        return 0;
